...
CREATE TABLE RAPID_JACKETS.CATALOGO (
  ID_CATALOGO INT NOT NULL AUTO_INCREMENT COMMENT '',
  NOMBRE VARCHAR(100) NOT NULL COMMENT '',
  DESCRIPCION VARCHAR(200) NULL COMMENT '',
  ACTIVO BOOLEAN NOT NULL DEFAULT TRUE COMMENT '',
  FOTO VARCHAR(250) DEFAULT 'SIN_ASIGNAR' NULL COMMENT '',
  PRIMARY KEY (ID_CATALOGO) 
  );


CREATE TABLE RAPID_JACKETS.PRODUCTO (
  ID_PRODUCTO VARCHAR(50) NOT NULL COMMENT '',
  CATEGORIA_ID_CATEGORIA INT NOT NULL COMMENT '',
  CATALOGO_ID_CATALOGO INT NOT NULL COMMENT '',
  ...
  FOTO VARCHAR(250) NOT NULL DEFAULT 'SIN_ASIGNAR' COMMENT '',
...
CREATE TABLE RAPID_JACKETS.USUARIO (
  ID_USUARIO VARCHAR(100) NOT NULL COMMENT '',
  CONTRASENA VARCHAR(300) NOT NULL COMMENT '',
...
CREATE TABLE RAPID_JACKETS.CUENTA (
  ...
  USUARIO_ID_USUARIO VARCHAR(100) NOT NULL COMMENT '',
  PRIMER_NOMBRE VARCHAR(45) NOT NULL COMMENT '',
  SEGUNDO_NOMBRE VARCHAR(45) NULL COMMENT '',
  PRIMER_APELLIDO VARCHAR(45) NOT NULL COMMENT '',
  SEGUNDO_APELLIDO VARCHAR(45) NULL COMMENT '',
...
CREATE TABLE RAPID_JACKETS.DOMICILIO_CUENTA (
  ...
  CORREO_POSTAL VARCHAR(60) NULL COMMENT '',
...
CREATE TABLE RAPID_JACKETS.FACTURA (
  ...
  OBSERVACIONES MEDIUMTEXT NULL COMMENT '',
